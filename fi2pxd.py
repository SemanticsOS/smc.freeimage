...
ENUMS = {
    ...
    'FREE_IMAGE_FORMAT' :
        ['FIF_UNKNOWN', 'FIF_BMP', 'FIF_ICO', 'FIF_JPEG', 'FIF_JNG',
         ...
         'FIF_PFM', 'FIF_PICT', 'FIF_RAW', 'FIF_WEBP', 'FIF_JXR',
         'FIF_LOAD_NOPIXELS'],
    ...
    'CONSTANTS' :
        ['FREEIMAGE_MAJOR_VERSION', 'FREEIMAGE_MINOR_VERSION',
         ...
         'RAS_DEFAULT',
         'RAW_DEFAULT', 'RAW_PREVIEW', 'RAW_DISPLAY', 'RAW_HALFSIZE', 'RAW_UNPROCESSED',
         'SGI_DEFAULT',
         ...
         'WBMP_DEFAULT',
         'WEBP_DEFAULT', 'WEBP_LOSSLESS',
         'JXR_DEFAULT', 'JXR_LOSSLESS', 'JXR_PROGRESSIVE',
         'XBM_DEFAULT',
         'XPM_DEFAULT'],
}
